                    ...
                    <div className="p-4 border border-[var(--border)] bg-[var(--muted)]/20 space-y-3">
                      ...
                      <div className="pt-2 border-t border-[var(--border)] space-y-1.5">
                        ...
                        <p className="text-[10px] opacity-70 leading-relaxed">
                          ...
                          • <strong>Assistente de Áudio & IA 1.4.3 (Saída Pura e Foco nos Destaques)</strong>: Eliminação de preâmbulos conversacionais e meta-análises; início direto em tópicos e destaques substantivos em todos os formatos de processamento de áudio.
                        </p>
                      </div>
